...
namespace LabNet2021.tp2.ConsoleApp
{
    class Program
    {
        ...
        static void MostrarExcepcionInfo(Exception e)
        {
        ...
        {
            Console.WriteLine("Llamando metodo (que lanza excepcion)...");
            try
            {
        ...
        {
            Console.WriteLine("Llamando metodo (con excepcion personalizada)...");
            try
            {
                Logic logic = new Logic();
